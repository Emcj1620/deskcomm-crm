...
- Estornos/chargebacks de pagamento já liquidado ainda exigem análise administrativa; não existe revogação automática de períodos nesta implementação. Não ativar cartão sem definir essa operação.
